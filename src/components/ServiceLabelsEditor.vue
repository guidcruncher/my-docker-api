<template>
  <div class="space-y-2">
    ...
    <div v-for="(_, idx) in rows" :key="idx" class="flex flex-col gap-1">
...
function errors(idx: number) {
  return useFieldError(props.issues, field(`labels[${idx}]`))
}
